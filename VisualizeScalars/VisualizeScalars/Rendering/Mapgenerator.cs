...
namespace VisualizeScalars.Rendering
{
    ...
    {
        private static readonly float Water = 0.1f;
        private static readonly float Sand = 0.2f;
        private static readonly float Dirt = 0.3f;
        private static readonly float Gras = 0.6f;
        private static readonly float Rock = 0.8f;
        private static readonly float Snow = 0.9f;
        private static readonly Material dirt = new Material {Color = new Vector4(170, 170, 170, 255) / 255};
        private static readonly Material gras = new Material {Color = new Vector4(0, 136, 0, 255) / 255};
